...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-purple-plum">
            <span class="caption-subject bold uppercase">Client Vehicle Types</span>
        </div>
        <div class="actions">
            <div class="btn-group">
    ...
    <thead>
        <tr>
            ...
            <th><?= $this->Paginator->sort('registrtion_number') ?></th>
            <th><?= $this->Paginator->sort('vehicle_model') ?></th>
            <th><?= $this->Paginator->sort('vehicle_color') ?></th>
            <th><?= $this->Paginator->sort('speed_limit') ?></th>
            <th><?= $this->Paginator->sort('fuel_tank_size') ?></th>
            <th><?= $this->Paginator->sort('fuel_type_id') ?></th>
    ...
    <?php foreach ($clientVehicles as $clientVehicle): ?>
        <tr>
            <td><?= $this->Number->format($clientVehicle->id) ?></td>
            <td><?= h($clientVehicle->registrtion_number) ?></td>
            <td><?= h($clientVehicle->vehicle_model) ?></td>
            <td><?= h($clientVehicle->vehicle_color) ?></td>
            <td><?= $this->Number->format($clientVehicle->speed_limit) ?></td>
            <td><?= $this->Number->format($clientVehicle->fuel_tank_size) ?></td>
            <td>
            ...
            <td class="actions">
                <?= $this->Html->link(__(''), ['action' => 'view', $clientVehicle->id],['class'=>'btn btn-xs fa fa-list text-primary']) ?>
