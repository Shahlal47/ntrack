...
<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-purple-plum">
            <span class="caption-subject bold uppercase"><?= __('Add Report Setting') ?></span>
        </div>
        <div class="actions">
            <div class="btn-group">
    ...
    <div class="portlet-body">
        <?= $this->Form->create($reportSetting,array('class' => 'form-horizontal')) ?>
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label">human_name</label>
            <div class="col-sm-3">
                <?php echo $this->Form->input('human_name', array('label' => false, 'class'=>'form-control')); ?>
            </div>
        </div><hr>
