...
<div class="portlet light">
    ...
    <thead>
        <tr>
            ...
            <th><?= $this->Paginator->sort('client_type_id') ?></th>
            <th><?= $this->Paginator->sort('company_type_id') ?></th>
    ...
    <?php foreach ($clientInfos as $clientInfo): ?>
        <tr>
            ...
            <td><?= h($clientInfo->address) ?></td>
            <td class="actions">
                <?= $this->Html->link(__(''), ['action' => 'view', $clientInfo->id],['class'=>'btn btn-xs fa fa-list text-primary']) ?>
