    ...
    <div class="portlet-body">
        <div class="panel-body">
            <table class="table table-bordered" align="center">
                ...
                <tr><td class="text-right">Sensor</td><td><?= h($clientInfo->sensors) ?></td></tr>
                <tr><td class="text-right">Number of Tracker</td><td><?= h($clientInfo->numOfTrackers) ?></td></tr>
                <tr><td class="text-right">Number of Geo Fences</td><td><?= h($clientInfo->numOfGeoFences) ?></td></tr>
            </table>
        </div>
    </div>
</div>
