<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-purple-plum">
            <span class="caption-subject bold uppercase"><?= __('Edit Client Type') ?></span>
        </div>
        <div class="actions">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $clientType->id],
    ...
    <div class="portlet-body">
        <?= $this->Form->create($clientType, array('class' => 'form-horizontal')) ?>
