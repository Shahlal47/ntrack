<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-purple-plum">
            <span class="caption-subject bold uppercase"><?= __('Edit Client Public ID') ?></span>
        </div>
        <div class="actions">
            <div class="btn-group">
                <a aria-expanded="false" class="btn btn-circle btn-default btn-sm" href="#" data-toggle="dropdown">Action <i class="fa fa-angle-down"></i></a>
                <ul class="dropdown-menu pull-right" role="menu">
                    <li><?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $clientPublicid->id], ['confirm' => __('Are you sure you want to delete # {0}?', $clientPublicid->id)])?></li>
    ...
    <div class="portlet-body">
        <?= $this->Form->create($clientPublicid, array('class' => 'form-horizontal')) ?>
        ...
        <div class="form-group">
            <label class="col-sm-4 control-label">Public ID</label>
            <div class="col-sm-3">
                <?php echo $this->Form->input('publicid', array('label' => false, 'class'=>'form-control')); ?>
            </div>
        </div><hr>
