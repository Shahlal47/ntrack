<div class="portlet light">
    <div class="portlet-title">
        <div class="caption font-purple-plum">
            <span class="caption-subject bold uppercase"><?= __('Edit Client Vehicle Assignment') ?></span>
        </div>
        <div class="actions">
            <div class="btn-group">
                ...
                <ul class="dropdown-menu pull-right" role="menu">
                    <li>
                        <?= $this->Form->postLink(__('Delete'),
                            ['action' => 'delete', $clientVehicleAssignment->id],
                            ['confirm' => __('Are you sure you want to delete # {0}?', $clientVehicleAssignment->id)]
                        )?>
                    </li>
